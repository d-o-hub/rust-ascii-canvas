...
| **F-13** | ❌ | [#111](https://github.com/d-o-hub/rust-ascii-canvas/issues/111) | **Not implemented** — layer ops bypass undo history (verified 2026-09-23: `History::undo(&mut Grid)`, layer calls have no commands). Issue #111 was closed with F-11 without it; the fresh issue is #207 with design in ADR-043 |
